...
\begin{tikzpicture}
	...
	\addplot table [x=WS, y=ERROR512]{tdnn_gon_error.dat};
	\addlegendentry{512 hidden units}
	\end{axis}
\end{tikzpicture}
\end{figure}
...
%	  ytick={0,10,...,70},
	...
	\addlegendentry{256 hidden units}
	\addplot table [x=WS, y=ERROR512]{tdnn_net_error.dat};
	\addlegendentry{512 hidden units}
	\end{axis}
\end{tikzpicture}
\end{figure}
...
%	  xtick={1,2,...,20},
	...
	\addlegendentry{256 hidden units}
	\addplot table [x=WS, y=ERROR512]{tdnn_man_error.dat};
	\addlegendentry{512 hidden units}
	\end{axis}
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}
	...
	\addlegendentry{256 hidden units}
	\addplot table [x=WS, y=TIME512]{tdnn_gon_time.dat};
	\addlegendentry{512 hidden units}
	\end{axis}
\end{tikzpicture}
\end{figure}
...
%	  ytick={0,0.1,...,0.2},
	...
	\addlegendentry{256 hidden units}
	\addplot table [x=WS, y=TIME512]{tdnn_net_time.dat};
	\addlegendentry{512 hidden units}
	\end{axis}
\end{tikzpicture}
\end{figure}
...
%	  ytick={0,0.1,...,0.2},
	...
	\addlegendentry{256 hidden units}
	\addplot table [x=WS, y=TIME512]{tdnn_man_time.dat};
	\addlegendentry{512 hidden units}
	\end{axis}
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=ERROR32]{tbptt_net_error.dat};
	\addlegendentry{32 hidden units}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=ERROR32]{tbptt_man_error.dat};
	\addlegendentry{32 hidden units}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=TIME32]{tbptt_net_time.dat};
	\addlegendentry{32 hidden units}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=TIME32]{tbptt_man_time.dat};
	\addlegendentry{32 hidden units}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=ERROR32]{cw_net_error.dat};
	\addlegendentry{32 hidden units}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=ERROR32]{cw_man_error.dat};
	\addlegendentry{32 hidden units}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=TIME32]{cw_net_time.dat};
	\addlegendentry{32 hidden units}
...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  height=180,
	  width=360]
	\addplot table [x=WS, y=TIME32]{cw_man_time.dat};
	\addlegendentry{32 hidden units}
